...
/**
 * Adaptador para el listado de concursos como usuarios correspondiente al ListView
 * Created by carlos on 17/03/16.
 */
public class ConcursoChatAdapter extends BaseAdapter
{
    private Activity actividad;
    private ArrayList<UsuarioChat> usuarios;
    private CustomFonts fuentes;

    public ConcursoChatAdapter(Activity actividad, ArrayList<UsuarioChat> usuarios)
    {
